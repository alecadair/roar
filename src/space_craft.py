...
class EquationBuilder(tk.Toplevel):
    ...
    def add_row(self):
        ...
        enable_checkbox = tk.Checkbutton(self.options_frame, variable=enable_row_var,
        ...
        self.entries.append((symbol_entry, function_entry, options_combobox, delete_button, enable_checkbox, enable_row_var))
    ...
    def delete_row(self, symbol_entry, function_entry, options_combobox, enable_checkbox, delete_button):
        ...
        self.entries = [(s, f, o, d, e, ev) for s, f, o, d, e, ev in self.entries if s != symbol_entry]
        self.num_entries -= 1
        self.update_scroll_region()
    ...
    def save_state(self):
        ...
        for entry in self.entries:
            symbol_entry, function_entry, options_combobox, delete_button, enable_box, enable_row_var = entry
    ...
    def load_state(self):
        ...
        try:
            ...
            for entry in self.entries:
                symbol_entry, function_entry, options_combobox, delete_button, enable_checkbox, enable_row_var = entry
                self.delete_row(symbol_entry, function_entry, options_combobox, enable_checkbox, delete_button)

            # Add rows from loaded state
            for row in state_data:
                self.add_row()
                symbol_entry, function_entry, options_combobox, delete_button, enable_checkbox, enable_row_var = self.entries[-1]
