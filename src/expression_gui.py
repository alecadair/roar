...
class CIDOptimizerSettings(ttk.Frame):
    def __init__(self, master, test=False):
        ...
        self.space_craft_button = ttk.Button(eval_update_frame, width=bigger_button_width, text="Open SpaceCraft", command=self.open_space_craft)
    ...
    def open_space_craft(self):
        builder = EquationBuilder(master=self.master)