...
class CIDLookupWindow(ttk.Frame):
    def __init__(self, parent, expand_callback, top_level_app):
        ...
        self.tech_browser = CIDTechBrowser(self.left_pane, lookup_window=self, top_level_app=self.top_level_app)
...
class CIDApp(ThemedTk):
    def __init__(self, theme, test=False):
       ...
       # self.top_level_pane.add(self.left_pane, weight=1)
        ...
        #self.left_pane.add_tech_luts(dirname="/home/adair/Documents/CAD/roar/characterization/predictive_28/LUTs_1V8_mac", pdk_name="predictive_28")
